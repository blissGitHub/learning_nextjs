...
const RightSidebar = () => {
  return (
    <section className="custom-scrollbar shadow-light-300 background-light900_dark200 light-border sticky top-0 right-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l p-6 pt-36 max-xl:hidden dark:shadow-none">
      <div>
      ...
      <div className="mt-16">
        ...
        <div className="mt-7 flex flex-col gap-4">
          {popularTags.map(({ _id, name, questions = { questions } }) => (
